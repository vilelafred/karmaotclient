...
function UIMinimap:setCrossPosition(pos)
  ...
  if self:getCameraPosition() == nil then
	--scheduleEvent(function() UIMinimap.setCrossPosition(pos) end, 5)
	return
  end
  if self:getCameraPosition().z == nil then
	return
  end
